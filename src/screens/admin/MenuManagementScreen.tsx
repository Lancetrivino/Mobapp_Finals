...
const CLOUDINARY_UPLOAD_PRESET = 'menu_item';
...
const uploadToCloudinary = async (fileUri: string): Promise<string> => {
  ...
  throw new Error(
    ...
    'Cloudinary upload failed. Check that your upload preset is set to Unsigned in the Cloudinary dashboard.'
  );
};
      ...
      <View style={styles.itemInfo}>
        ...
        <View style={styles.itemActions}>
          ...
          <TouchableOpacity
            style={[
              styles.actionBtn,
              { backgroundColor: item.available ? theme.colors.warningLight : theme.colors.successLight },
            ]}
...
const styles = StyleSheet.create({
  ...
  addBtn: {
    ...
    alignItems: 'center', justifyContent: 'center', ...theme.shadows.medium,
  },
  ...
  itemCard: {
    ...
    borderColor: theme.colors.border, gap: theme.spacing.md, ...theme.shadows.small,
  },
  itemCardDim: { opacity: 0.65 },
  itemIconWrap: { width: 56, height: 56, borderRadius: theme.borderRadius.medium, alignItems: 'center', justifyContent: 'center' },
  itemImage: { width: 56, height: 56, borderRadius: theme.borderRadius.medium },
  itemInfo: { flex: 1 },
  ...
  imagePicker: {
    ...
    marginBottom: theme.spacing.lg, borderWidth: 1, borderColor: theme.colors.border,
  },
  imagePreview: { width: '100%', aspectRatio: 4 / 3 },
  imageEditBadge: {
    position: 'absolute', bottom: 10, right: 10, flexDirection: 'row', alignItems: 'center',
    gap: 5, backgroundColor: 'rgba(0,0,0,0.6)', paddingHorizontal: 10, paddingVertical: 5,
    borderRadius: theme.borderRadius.full,
  },
  imageEditText: { fontSize: 12, fontWeight: '700', color: '#fff' },
  imagePlaceholder: { aspectRatio: 4 / 3, backgroundColor: theme.colors.background, alignItems: 'center', justifyContent: 'center', gap: 8 },
  imagePlaceholderIcon: {
    width: 52, height: 52, borderRadius: 26, backgroundColor: theme.colors.surface,
